...
(defn get-positions [claim]
  (let [[_ x y width height] (map read-string (re-seq #"\d+" claim))
...
(deftest find-all-overlapping-positions
  (testing "sample data"
    (let [claims ["#1 @ 1,3: 4x4" "#2 @ 3,1: 4x4" "#3 @ 5,5: 2x2"]]
      (is (= 4 (find-overlap claims))))
    (let [claims ["#1 @ 1,3: 4x4" "#2 @ 3,1: 4x4" "#4 @ 3,3: 30x30"]]
